...
$password = "ezLj/L1jq4R5"; // Senha do banco de dados (deixe em branco se não houver senha configurada)
$dbname = "memoria_maluquinha"; // Nome do banco de dados que será acessado
